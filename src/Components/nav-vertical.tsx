...
import { Box, AppBar, Drawer, Toolbar, List, ListItem, Typography, Container } from '@mui/material';
    ...
    <Box sx={{ display: 'flex'  , justifyContent:'center'}}>
      ...
      >
        ...
        <List sx={{ flexGrow: 1 }}>
          ...
          {/* Sidebar Items */}
          <ListItem
            sx={{ margin: 'auto', borderRadius: '8px', padding: '1rem', width: '80%', backgroundColor: activePage === 'Matches' ? 'rgba(250, 250, 250, 0.2)' : '' }}
            button
          ...
          {/* Additional Items */}
          <ListItem
            sx={{ margin: 'auto', borderRadius: '8px', padding: '1rem', width: '80%', backgroundColor: activePage === 'Notifications' ? 'rgba(250, 250, 250, 0.2)' : '' }}
            button
        ...
        {/* Settings and Logout */}
        <List sx={{ pb: '2rem' }}>
          <ListItem sx={{ margin: 'auto', borderRadius: '8px', padding: '1rem', width: '80%' }}>
